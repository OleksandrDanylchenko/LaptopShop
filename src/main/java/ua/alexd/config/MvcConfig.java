...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(@NotNull ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/favicon.ico")
                .addResourceLocations("classpath:/static/public/images/favicon.ico");
        registry.addResourceHandler("/navbarLogo.png")
                .addResourceLocations("classpath:/static/public/images/navbarLogo.png");
